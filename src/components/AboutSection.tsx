...
export function AboutSection() {
  ...
  return (
    <section
      id="haqida"
      className="relative py-20 lg:py-32 bg-black overflow-hidden mt-2 mb-2"
    >
      {/* Background */}
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-10 lg:gap-16 items-center">
          ...
          >
            ...
            <p className="text-gray-400 mb-6 text-sm sm:text-base">
              So‘zlaringiz Kuchga Aylanadigan Kun! To‘g‘ri yozilgan prompt —
              minglab natijalarga eshik ochadi. Bu tadbir sizga AI bilan
              professional darajada “muloqot qilishni” o‘rgatadi.
            </p>
          ...
          >
            ...
            <div
              className="relative rounded-3xl overflow-hidden border-2 border-purple-500/30 backdrop-blur-sm 
