...
export default function Register(): JSX.Element {
  ...
  async function handleSubmit(e: React.FormEvent) {
    ...
    const regionObj = regions.find(
      (region) =>
        region.id === Number(payload.region) ||
        region.soato_id === Number(payload.region)
    );
  ...
  return (
    <div
      className="min-h-screen text-white py-10 p-[20px] px-4 flex flex-col items-center justify-center"
      style={{ zIndex: 50 }}
    >
      <div className="max-w-6xl mx-auto grid grid-cols-1 lg:grid-cols-3 gap-8 z-10 w-full">
        <aside className="lg:col-span-1 rounded-l-2xl overflow-hidden bg-gradient-to-b from-gray-900 to-gray-800 shadow-lg flex flex-col">
          ...
          <div className="p-6 bg-gradient-to-br from-purple-950/60 via-black/60 to-blue-950/60 rounded-2xl shadow-xl backdrop-blur-md border border-white/10 flex flex-col gap-4">
            ...
            <button
              onClick={() => navigate("/")}
              className="mt-2 w-full py-3 rounded-xl px-6 text-white font-semibold transition bg-purple-600 hover:bg-purple-500"
            >
              <i className="fa-solid fa-arrow-left"></i> Asosiy sahifaga o'tish
            </button>
          </div>
        </aside>
        ...
        <main className="lg:col-span-2 bg-gray-900 rounded-2xl p-6 shadow-2xl z-20">
          {done ? (
            <div
              style={{ border: 0 }}
              className="text-center space-y-6 rounded-2xl p-8 bg-gradient-to-br from-purple-900 via-purple-800 to-purple-700 animate-fadeIn"
            >
              {/* Animated check mark */}
              <div className="flex justify-center border-lg border-0 rounded-full w-24 h-24 mx-auto bg-gradient-to-tr from-green-500 to-green-400 shadow-lg items-center">
                <svg
                  className="w-20 h-20 text-green-400 animate-bounce border-2 rounded-full"
                  style={{ borderBlockColor: "green", border: "2px solid" }}
                  fill="none"
                  stroke="currentColor"
                  strokeWidth="2"
                  viewBox="0 0 24 24"
              ...
              <p className="text-gray-400 text-sm md:text-xl max-w-2xl mx-auto">
                ...
                Yangilik va e’lonlarni ijtimoiy tarmoqlardagi sahifalarimiz
                orqali kuzatib boring. 🎉
              </p>
              ...
              {block.link === "/register/contest" ? (
                    ...
                    <div className="text-center topp space-y-6">
                      <div className="bg-gradient-to-r from-purple-500/20 to-blue-500/20 rounded-2xl p-4 sm:p-6 md:p-8 border border-purple-500/30">
                        ...
                        <p className="text-gray-300 mb-6 text-sm sm:text-base md:text-lg">
                          Quyidagi ijtimoiy tarmoq sahifalarimizga obuna bo'ling
                          va <br />
                      ...
                      <div className="flex flex-col sm:flex-row justify-center gap-3 mt-6">
                        <a
                          href={
                            agree ? "https://raqamliavlod.uz/kontest/" : "#"
                          }
                          target="_blank"
                          rel="noopener noreferrer"
                          className={`flex-1 px-4 py-3 rounded-xl text-center hover:bg-purple-500 transition font-semibold ${
                            !agree
                ...
                >
                  ...
                  <div className="grid grid-cols-1 md:grid-cols-2 gap-3">
                    <label className="block">
                      ...
                      <input
                        ...
                        required
                        className="mt-1 w-full rounded-xl bg-white text-black border border-gray-300 px-4 py-3"
                      />
                    </label>
                    <label className="block">
                  ...
                  <div className="grid grid-cols-1 md:grid-cols-2 gap-3">
                    ...
                    <label className="block">
                      ...
                      <input
                        ...
                        onChange={(e) =>
                          setField("telegram_username", e.target.value)
                        }
                        className="mt-1 w-full rounded-xl bg-white text-black border border-gray-300 px-4 py-3"
                      />
                    </label>
                  ...
                  <div className="grid grid-cols-1 md:grid-cols-2 gap-3">
                    ...
                    <label className="block">
                      ...
                      <input
                        ...
                        onChange={(e) =>
                          setField("study_place", e.target.value)
                        }
                        required
                  ...
                  <div className="grid grid-cols-1 md:grid-cols-2 gap-3">
                    ...
                    <div>
                      ...
                      >
                        ...
                        {districts
                          .filter(
                            (d) => String(d.region_id) === String(form.region)
                          )
                          .map((district) => (
                            <option
                              key={district.id}
                    ...
                    <label className="block">
                      ...
                      <select
                        ...
                        style={{
                          ...
                          color: "white",
                          border: "1px solid white",
                        }} // Qo'shimcha inline style
                      >
                        <option value="ai" className="bg-gray-900">
                          Sun'iy intelekt
                        </option>
                        <option value="fixtirolar" className="bg-gray-900">
                          Foydali ixtirolar
                        </option>
                        <option value="rfutbol" className="bg-gray-900">
                          Robo futbol
                        </option>
                        <option value="rsumo" className="bg-gray-900">
                          Robo sumo
                        </option>
                        <option value="contest" className="bg-gray-900">
                          DG Contest
                        </option>
                      </select>
                    </label>
                    ...
                    <div className="mt-8 p-4 rounded-xl border border-purple-500/30 bg-purple-900/10">
                      ...
                      <div className="grid grid-cols-1 md:grid-cols-2 gap-3">
                        <label className="block">
                          ...
                          <input
                            ...
                            onChange={(e) =>
                              setFriendField("first_name", e.target.value)
                            }
                            required
                            className="mt-1 w-full rounded-xl bg-white text-black border border-gray-300 px-4 py-3"
                          />
                        ...
                        <label className="block">
                          ...
                          <input
                            ...
                            onChange={(e) =>
                              setFriendField("last_name", e.target.value)
                            }
                            required
                            className="mt-1 w-full rounded-xl bg-white text-black border border-gray-300 px-4 py-3"
                          />
                      ...
                      <div className="grid grid-cols-1 md:grid-cols-2 gap-3">
                        <label className="block">
                          ...
                          <input
                            type="text"
                            value={friendForm.middle_name}
                            onChange={(e) =>
                              setFriendField("middle_name", e.target.value)
                            }
                            required
                            className="mt-1 w-full rounded-xl bg-white text-black border border-gray-300 px-4 py-3"
                          />
                        ...
                        <label className="block">
                          ...
                          <select
                            ...
                            onChange={(e) =>
                              setFriendField("gender", e.target.value)
                            }
                            required
                            style={{ border: "1px solid white" }}
                            className="mt-1 w-full rounded-xl bg-white text-black border border-gray-300 px-4 py-3"
                      ...
                      <div className="grid grid-cols-1 md:grid-cols-2 gap-3">
                        <label className="block">
                          <PhoneNumberInput
                            ...
                            onChange={(v) => setFriendField("phone_number", v)}
                          />
                        </label>
                        <label className="block">
                          <span className="text-sm text-gray-300">
                          ...
                          <input
                            type="text"
                            value={friendForm.telegram_username}
                            onChange={(e) =>
                              setFriendField(
                                "telegram_username",
                                e.target.value
                      ...
                      <div className="grid grid-cols-1 md:grid-cols-2 gap-3">
                        <label className="block">
                          ...
                          <input
                            ...
                            onChange={(e) =>
                              setFriendField("birth_date", e.target.value)
                            }
                            required
                            className="mt-1 w-full rounded-xl bg-white text-black border border-gray-300 px-4 py-3"
                          />
                        ...
                        <label className="block">
                          ...
                          <input
                            ...
                            onChange={(e) =>
                              setFriendField("study_place", e.target.value)
                            }
                            required
                            className="mt-1 w-full rounded-xl bg-white text-black border border-gray-300 px-4 py-3"
                          />
                      ...
                      <div className="grid grid-cols-1 md:grid-cols-2 gap-3">
                        ...
                        <div>
                          ...
                          <select
                            ...
                            onChange={(e) =>
                              setFriendField("district", e.target.value)
                            }
                            className="w-full p-3 rounded-lg font-semibold shadow focus:outline-none"
                            style={{
                              color: "#fff",
                      ...
                      <label className="block">
                        ...
                        <input
                          ...
                          onChange={(e) =>
                            setFriendField("email", e.target.value)
                          }
                          className="mt-1 w-full rounded-xl bg-white text-black border border-gray-300 px-4 py-3"
                        />
                      </label>
                      <label className="block">
                        ...
                        <textarea
                          value={friendForm.about}
                          onChange={(e) =>
                            setFriendField("about", e.target.value)
                          }
                          required
                          className="mt-1 w-full rounded-xl bg-white text-black border border-gray-300 px-4 py-3"
                          rows={3}
                  ...
                  <h2 className="text-center">
                    Ro'yxatdan o'tish va eng so'ngi yangliklardan xabardor{" "}
                    <br /> bo'lish uchun obuna bo'ling 👇
                  </h2>
                  ...
                  <div>
                    <div className="box2 text-center mt-6">
                      <label
                        className="flex items-center justify-center mt-8 gap-2 cursor-pointer"
                      ...
                      >
                        <input
                          ...
                          onChange={(e) => setAgree(e.target.checked)}
                        />
                        Ishtirok etishga tayormisiz ?
                      </label>
                    </div>
                    <div
                      className="flex buttonSend gap-3 mt-6"
                      style={{ marginTop: "20px" }}
                    >
                      <button
                        type="submit"
                        disabled={loading || !agree}
                        className={`flex-1 px-4 py-3 rounded-xl  hover:bg-purple-500 disabled:opacity-60 transition font-semibold ${
                          loading || !agree
                            ? "btn-disabled bg-purple-400 cursor-not-allowed"
